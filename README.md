...
It maximizes the likelihood of data assuming a certain number of gaussian distributions with different means and covariance matrices. GMM can be used for generative unsupervised learning or clustering
